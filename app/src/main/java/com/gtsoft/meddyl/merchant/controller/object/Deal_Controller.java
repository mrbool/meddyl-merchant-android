...
public class Deal_Controller extends Base_Controller implements Parcelable
{
	...
	/* custom variables */
	private Fine_Print_Option[] fine_print_option_obj_array_all;
	...
	public void writeToParcel(Parcel out, int flag)
	{
		...
		/* custom */
		out.writeTypedArray(fine_print_option_obj_array_all, flag);
	}
	...
	private Deal_Controller(Parcel in)
	{
		...
		/* custom */
		fine_print_option_obj_array_all = in.createTypedArray(Fine_Print_Option.CREATOR);
	}

	public static final Creator<Deal_Controller> CREATOR = new Creator<Deal_Controller>()
	{
	...
	public void Verify_Deal()
	{
		...
		else
		{
			...
			Deal deal_obj_hold = (Deal)i_rest.getJSONSuccessfulResponse().getDataObj();

			deal_obj.setDeal(deal_obj_hold.getDeal());
			deal_obj.setFinePrintExt(deal_obj_hold.getFinePrintExt());
		}
	}

	public void Add_Deal()
	{
		system_error_obj = null;
		system_successful_obj = null;

		promotion_obj = new Promotion();
		promotion_obj.setPromotionCode("");
		...
		deal_obj.setLoginLogObj(login_log_obj);
		deal_obj.setMerchantContactObj(merchant_contact_obj);
		deal_obj.setPromotionActivityObj(promotion_activity_obj);

		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Add_Deal(deal_obj);
	...
	public void Send_Deal_Validation()
	{
		system_error_obj = null;
		system_successful_obj = null;
		...
		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Send_Deal_Validation(deal_obj);
	...
	public void Validate_Deal()
	{
		...
		deal_obj.setLoginLogObj(login_log_obj);
		deal_obj.setMerchantContactObj(merchant_contact_obj);
		deal_obj.setDealValidationObj(deal_validation_obj);

		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Validate_Deal(deal_obj);
	...
	public void Get_Deals()
	{
		...
		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Get_Deals(merchant_contact_obj);
	...
	public void Lookup_Certificate()
	{
		...
		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Lookup_Certificate(certificate_obj);
		...
		else
		{
			...
			certificate_obj = certificate_payment_obj.getCertificateObj();
			customer_obj = certificate_obj.getCustomerObj();
			deal_obj = certificate_obj.getDealObj();
		}
	}
	...
	public void Redeem_Certificate()
	{
		...
		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Redeem_Certificate(certificate_obj);
	...
	/* custom properties */
	public Fine_Print_Option[] getFinePrintOptionObjArrayAll()
	{
		return this.fine_print_option_obj_array_all;
	}

	public void setFinePrintOptionObjArrayAll(Fine_Print_Option[] fine_print_option_obj_array_all)
	{
		this.fine_print_option_obj_array_all = fine_print_option_obj_array_all;
	}
