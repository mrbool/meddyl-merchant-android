...
public class System_Controller extends Base_Controller implements Parcelable
{
	...
	public static final Creator<System_Controller> CREATOR = new Creator<System_Controller>()
	{
	...
	public void Get_Neighborhood_By_Zip()
	{
		...
		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Get_Neighborhood_By_Zip(zip_code_obj);
		...
		{
			system_successful_obj = i_rest.getJSONSuccessfulResponse().getSystemSuccessful();
			zip_code_obj = (Zip_Code)i_rest.getJSONSuccessfulResponse().getDataObj();
		}
	}
	...
	public void Get_Fine_Print_Options()
	{
		...
		REST_MerchantService i_rest = new REST_MerchantService(merchant_service);
		i_rest.Get_Fine_Print_Options(login_log_obj);
		...
		{
			system_successful_obj = i_rest.getJSONSuccessfulResponse().getSystemSuccessful();
			fine_print_option_obj_array = (Fine_Print_Option[])i_rest.getJSONSuccessfulResponse().getDataObj();
		}
	}
